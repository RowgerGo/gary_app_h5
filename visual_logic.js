 ...
 * Thu May 11 2023 13:26:25 GMT+0800 (中国标准时间)
...
var PROC = {
    "setCameraPositionDefault": setCameraPositionDefault,
    "setCameraPositionBack": setCameraPositionBack,
    "setCameraPositionLeft": setCameraPositionLeft,
    "setCameraPositionRight": setCameraPositionRight,
    "setDefault": setDefault,
    "roteXAction": roteXAction,
    "setLIne": setLIne,
};
...
function setDefault() {
  ...
  pepperPath = './dr.pepper model.gltf';
...
// Describe this function...
function setLIne() {
  spritePath = './sprite line.gltf';
  cocacolaPath = './Cocacola line.gltf';
  pepperPath = './dr.pepper line.gltf';
}
...
eventHTMLElem('click', ['QUERYSELECTOR', '#SpriteSwitch'], true, function(event) {
  ...
  unloadScene(pepperPath);
  appendScene(spritePath, spritePath, false, false, function() {}, function() {}, function() {});
});
eventHTMLElem('click', ['QUERYSELECTOR', '#PepperSwitch'], true, function(event) {
  ...
  unloadScene(cocacolaPath);
  unloadScene(spritePath);
  appendScene(pepperPath, pepperPath, false, false, function() {}, function() {}, function() {});
});
...
eventHTMLElem('click', ['QUERYSELECTOR', '.RenderWire'], true, function(event) {
  ...
  unloadScene('./dr.pepper model.gltf');
  console.log(current);
  setDefault();
  if (current == 1) {
    setLIne();
...
eventHTMLElem('click', ['QUERYSELECTOR', '.RenderDefault'], true, function(event) {
  ...
  unloadScene('./dr.pepper line.gltf');
  appendScene(cocacolaPath, cocacolaPath, false, false, function() {}, function() {}, function() {});
